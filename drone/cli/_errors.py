...
Every failure inside drone-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`drone.cli._output`,
...
# Exit-code policy. Documented in ``drone-cli learn`` output.
# 0      = success
